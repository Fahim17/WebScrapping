...
url = "https://www.cars.com/for-sale/searchresults.action/?bsId=20211&dealerType=all&page=1&perPage=100&rd=30&searchSource=PAGINATION&sort=relevance&zc=60606"
page = urlopen(url)
soup = BeautifulSoup(page, features="lxml")

getAll = soup.find_all("a", class_ = "shop-srp-listings__listing")
